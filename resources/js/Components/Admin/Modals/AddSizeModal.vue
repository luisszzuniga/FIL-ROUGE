        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                    <h2 class="text-lg">Créer une nouvelle taille de plats</h2>
                </div>
                <div class="mt-5">
                    <label for="name" class="block text-sm font-medium text-gray-700">Nom de la taille</label>
...
export default {
    setup(props, { emit }) {
        ...
        function submit() {
            form.post(route('admin.plate-size.add'), {
                preserveScroll: true,
                onSuccess: () => {
                    form.reset(),
                    emit('close')
